...
API_URL = os.getenv("API_URL_DataRobot")
API_KEY = os.getenv("API_KEY_DataRobot")
DATAROBOT_KEY = os.getenv("DATAROBOT_KEY_DataRobot")
DEPLOYMENT_ID = os.getenv("DEPLOYMENT_ID_DataRobot")
...
# Page setup
st.set_page_config(page_title="Marketing Compliance Advisor", page_icon=":bar_chart:", layout="centered")
st.title(":bar_chart: Marketing Compliance Advisor")
