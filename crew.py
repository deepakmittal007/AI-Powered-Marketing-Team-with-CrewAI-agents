...
llm = LLM(
    model=os.getenv("OPENAI_API_DEPLOYMENT_ID"),
...
if __name__ == "__main__":
    ...
    inputs = {
        "product_name": "DataRobot for AI/ML Solutions",
        "target_audience": "Small and Medium Enterprises (SMEs)",
        "product_description": "A tool that automates repetitive tasks of predictive modelling using AI, saving time and reducing errors.",
        "budget": 500000,
